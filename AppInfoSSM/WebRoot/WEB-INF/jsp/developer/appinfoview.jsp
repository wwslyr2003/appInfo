    ...
    <div class="x_panel">
						...
						<tbody>
							<c:forEach var="appVersion" items="${appVersionList }" varStatus="status">
								<tr role="row" class="odd">
									...
									<td> ${appInfo.versionId==appVersion.id?"已发布":"待发布" }</td>
									<td>
     ...
     <div class="form-group">
        <div class="col-md-6 col-md-offset-3">
          <button type="button" class="btn btn-primary"id="back"><a href="${pageContext.request.contextPath }/dev/devdevlist.html">返回</a></button>
        </div>
      </div>
    <div class="clearfix"></div>
    <br/><br/>
